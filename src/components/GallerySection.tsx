      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
          {images.map((image, index) => (
            <div
              key={index}
              className={`relative group ${image.span} overflow-hidden rounded-2xl`}
            >
              <img
                src={image.src}
                alt={image.alt}
        ...
        <div className="text-center mt-12">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 text-chili font-semibold hover:text-chili/80 transition-colors"
          >
