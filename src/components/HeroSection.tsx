...
const HeroSection = () => {
  const badges = [
    { icon: Utensils, text: "Best tacos in Eindhoven" },
    { icon: Music, text: "Great music" },
    { icon: Sparkles, text: "Colorful vibes" },
  ];
      ...
      <div className="relative z-10 container mx-auto px-4 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="inline-flex items-center gap-2 bg-cream/20 backdrop-blur-sm text-cream px-4 py-2 rounded-full mb-6 animate-fade-in-up">
            ...
            <span className="text-sm font-medium">Vestdijk 39, Eindhoven</span>
          </div>

          {/* Main Headline */}
          <h1 className="font-display text-5xl sm:text-6xl md:text-7xl lg:text-8xl text-cream leading-none mb-6 animate-fade-in-up" style={{ animationDelay: "0.1s" }}>
            COLOR, FLAVOR
            <br />
            <span className="text-mango">&</span> GOOD VIBES
          </h1>

          {/* Subheadline */}
          <p className="text-lg md:text-xl text-cream/90 max-w-2xl mx-auto mb-8 animate-fade-in-up" style={{ animationDelay: "0.2s" }}>
            Authentic Mexican food, vibrant drinks, and a chill tropical atmosphere — right in the heart of Eindhoven.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12 animate-fade-in-up" style={{ animationDelay: "0.3s" }}>
            ...
            <Button variant="outline-light" size="xl" asChild>
              <a href="#location">Plan Your Visit</a>
            </Button>
          </div>
